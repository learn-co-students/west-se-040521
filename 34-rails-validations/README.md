...
- For example, would it make sense for our app to allow a pet with an empty name to be created?
...
- [Flash docs](https://api.rubyonrails.org/classes/ActionDispatch/Flash.html)
- [RubyGuides on Flash](https://www.rubyguides.com/2019/11/rails-flash-messages)
