...
# byebug
artArr.each{|art| 
artist = Artist.find_or_create_by(name: art[:artist][:name], hometown: art[:artist][:hometown], birthday: art[:artist][:birthday], deathday: art[:artist][:deathday])
Art.create(title: art[:title], image:art[:image], slug: art[:slug], date: art[:date], votes: art[:votes], artist_id: artist.id)
}
